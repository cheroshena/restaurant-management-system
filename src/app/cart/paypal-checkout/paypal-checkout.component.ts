...
import { getCartItems, getCartItemsCount, getCartSubTotal, getEstimatedTax, getOrderTotal, getShippingCost } from 'src/app/core/cart/cart-selector';
...
import { OrderService } from 'src/app/core/orders/order.service';
...
export class PaypalCheckoutComponent implements OnInit, OnDestroy {
  ...
  get paypalConfig(){
    return{
      ...
      env:"sandbox",
      client:{sandbox:"AVENM8EkFG2IC2tzuX4XkkLLANmP4RApXGiF5yGALj6YvZ0wc9K1i6eEdQhpCty_HvTRgZ4CFl56gEPI"},
      commit: true,
